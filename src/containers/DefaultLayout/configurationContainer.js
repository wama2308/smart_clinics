                    ...
                    <div className="container">
                      <div className="">
                        <p className="text-muted">
                          Ajuste la informacion de las sucursales de su Centro
                          Medico
                        </p>
                      </div>
                      <div className="App">
                      ...
                      <Table hover responsive borderless>
                        ...
                        <tbody>
                          {Object.keys(this.state.branchoffices).map(
                            (item, i) => {
                              if (
                                this.state.branchoffices[item].status === true
                              ) {
                                var a = this.state.branchoffices[item]
                                  .countryId;
                                var b = "";
                                var c = [];
                                var d = this.state.branchoffices[item]
                                  .provinceId;
                                var f = "";
                                ...
                                return (
                                  <tr>
                                    <td>
                                      {this.state.branchoffices[item].name}
                                    </td>
                                    <td>
                                      {this.state.branchoffices[item].code}
                                    </td>
                                    <td>{b}</td>
                                    <td>{f.name}</td>
                                    <td>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <ModalBody>
                          <div
                            color="success"
                            className={this.state.alertCheck}
                          >
                            <FaCheckCircle size="4em" />
                          </div>
                          ...
                          <Table hover responsive borderless>
                            ...
                            <tbody>
                              {Object.keys(this.state.licenses).map(
                                (item, i) => {
                                  var date = new Date(
                                    this.state.licenses[item].expiration_date
                                      .sec * 1000
                                  );
                                  var date2 = new Intl.DateTimeFormat(
                                    "en-GB"
                                  ).format(date);
                                  return (
                                    <tr class="text-center">
                                      <td>
                                        {this.state.licenses[item].license}
                                      </td>
                                      <td>
                                        {
                                          this.state.licenses[item]
                                            .numberclients
                                        }
                                      </td>
                                      <td>
                                        {this.state.licenses[item].numberexams}
                                      </td>
                                      <td>
                                        {this.number_format(
