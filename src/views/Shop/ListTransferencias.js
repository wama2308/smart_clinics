            ...
            <Table hover responsive borderless>
              <thead className="thead-light">
                <tr>
                  ...
                  <th className="text-left" style={{width:'20%'}}>Control</th>
                  ...
                  <th className="text-left" style={{ 'minWidth': "105px", width:'10%' }}>Acciones</th>
                </tr>
              </thead>
              <tbody>
                {
