...
class ListShop extends React.Component {
  ...
  openModal = (option, pos, id) => {
    if (!this.props.provider) {
      this.props.alert(
        "warning",
        "¡Antes de agregar una compra, debe agregar un proveedor!"
      );
    } else {
      if (option === 1) {
        this.setState({
                      ...
                      <td style={{ minWidth: "205px" }}>
                        <div className="float-left">
                          <IconButton
                            ...
                            onClick={() => {
                              this.openModal(2, shop.number, shop._id);
                            }}
                          >
                          ...
                          <IconButton
                            ...
                            className="iconButtons"
                            onClick={() => {
                              this.openModal(3, shop.number, shop._id);
                            }}
                          >
                          ...
                          <IconButton
                            ...
                            className="iconButtons"
                            onClick={() => {
                              this.openModal(4, shop.number, shop._id);
                            }}
                          >
