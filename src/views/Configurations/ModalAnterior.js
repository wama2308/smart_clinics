        ...
        <div className={this.state.divContainer}>
            ...
            {/* ---------------------------------------------------------Contactos--------------------------------------------------------------- */}
                    ...
                    <div className="form-group col-lg-12 Widht">
                            ...
                            <Card >
                                <CardBody >
                                    <Form  className={this.state.contactview} id="2">
                                        <p className="text-muted">Agregue la informacion de los contactos</p>  
                                            <div className="error">{this.state.AddContact}</div>
                                                <div className="row">
                                                    <FormGroup className="top form-group col-sm-6" >
                                                        <Label for="Nombre">Contacto</Label>
                                                        <Input name="name"   type="text" id="name"  value={this.state.name}  onKeyUp={this.handlekey1} valid={this.state.nombreValid} invalid={this.state.nombreInvalid} maxLength="10"onChange={event => this.setState({name: event.target.value})} pattern="^[A-Za-z]*$" />
                                                        <FormFeedback tooltip>{this.state.nombreError}</FormFeedback>  
                                                    </FormGroup>

                                                    <FormGroup className="top form-group col-sm-6" >
                                                        <Label for="Telefono" >Telefono</Label>
                                                        <Input name="phone" id="telefono" value={this.state.phone}  type="number"  onKeyUp={this.handlekey2} valid={this.state.telefonoValid} invalid={this.state.telefonoInValid} pattern="^[0-9]*$" maxLength="10" onChange={event => this.setState({phone: event.target.value})} />
                                                        <FormFeedback tooltip>{this.state.telefonoError}</FormFeedback>  
                                                    </FormGroup>

                                                    <FormGroup className="top form-group col-sm-6" >
                                                        <Label for="Email" className="mr-sm-2">Email</Label>
                                                        <Input name="email" id="Email"  type="email" value={this.state.email} onKeyUp={this.handlekey3} valid={this.state.emailValid} invalid={this.state.emailInvalid} onChange={event => this.setState({email: event.target.value})} />
                                                        <FormFeedback tooltip>{this.state.emailError}</FormFeedback>  
                                                    </FormGroup>
                                                </div>      
                                                <div >
                                                    <Button  onClick={this.handleSubmitContact} className="add top"color="primary">Añadir</Button>
                                                </div>
                            ...
                            <Collapse isOpen={this.state.collapseMap}>
                                <Card>
                                    ...
                                    <div>
                                        ...
                                        />
                                        <br />
                                        <Button color="success" onClick={this.refrescarMapa}>Refrescar</Button>
                                    </CardBody>  
                                </Card>
                            </Collapse>
                        </div>
                                    ...
                                    <CardBody>
                                        <div className="container">
                                            <form className={this.state.contactview}>
                                                ...
                                                <div className="row">
                                                    <div className={"top  form-group col-sm-6"}>
                                                        <label>Logo</label>
                                                        <br />
                                                        <Input className="top" type="file" accept="image/*" invalid={this.state.logoInvalid} valid={this.state.logoValid} onChange={this.fileHandlerLogo} />
                                                    ...
                                                    <div className="top  form-group col-sm-6">
                                                        <label>Foto 1</label>
                                                        <br />
                                                        <Input type="file" accept="image/*"onChange={this.fileHandleFoto1} invalid={this.state.foto1Invalid} />
                                                        <FormFeedback tooltip>{this.state.foto1Error}</FormFeedback>  
                                                    </div>                        
                                                    <div className="top form-group col-sm-6">
                                                        <label>Foto 2</label>
                                                        <br />
                                                        <Input type="file" accept="image/*" onChange={this.fileHandleFoto2} invalid={this.state.foto2Invalid} />
                                                        <FormFeedback tooltip>{this.state.foto2Error}</FormFeedback>  
                                                    </div>
                                                    <div className="top  form-group col-sm-6">
                                                        <label>Foto 3</label>
                                                        <br />
                                                        <Input type="file" accept="image/*" onChange={this.fileHandleFoto3} invalid={this.state.foto3Invalid} />
                                                        <FormFeedback tooltip>{this.state.foto3Error}</FormFeedback>  
                                                    </div>
                                                </div>
                                            </form>
                                            ...
                                            <div className={this.state.divfilehide}>
                                                {
                                                this.state.logo != null && <img style={{width: 150, height: 150}}  className="image"  src={"data:image/jpeg;" + this.state.logo} />
                                                }
                                                {
                                                this.state.foto1 != null  &&  <img style={{width: 150, height: 150}} className="image"  src={"data:image/jpeg;" + this.state.foto1} />
                                                }
                                                {
                                                this.state.foto2 != null && <img style={{width: 150, height: 150}}  className="image"  src={"data:image/jpeg;" + this.state.foto2} />
                                                }        
                                                {
                                                this.state.foto3 != null &&  <img style={{width: 150, height: 150}}  className="image" src={"data:image/jpeg;" + this.state.foto3} />
                                                }
                                            </div>
                                        </div>
                                    </CardBody>
                                        ...
                                        <div className="container">
                                            ...
                                            <div className="row">
                                                <div className="form-group col-sm-6">
                                                    ...
                                                    <Input placeholder="Ingrese Twitter de Centro Medico" value={this.state.twitter} onChange={event => this.setState({twitter:event.target.value})} />
                                                </div>
                                                <div className="form-group col-sm-6">
                                                    <label><FaInstagram /></label>
                                                    <Input placeholder="Ingrese Instagram de Centro Medico" value={this.state.instagram} onChange={event => this.setState({instagram:event.target.value})} />
                                                </div>
                                                <div className="form-group col-sm-6">
                                                    <label><FaFacebook /></label>
                                                    <Input placeholder="Ingrese Facebook de Centro Medico" value={this.state.facebook} onChange={event => this.setState({facebook:event.target.value})} />
                                                </div>
                                                <div className="form-group col-sm-6">
                                                    <label><FaExternalLinkAlt /></label>
                                                    <Input placeholder="Ingrese la web del Centro Medico" value={this.state.web} onChange={event => this.setState({web:event.target.value})} />
                                                </div>
                                            </div>
                                        </div>
                                    </CardBody>
                        ...
                        <div>
                            <Modal isOpen={this.state.modalAlert}  className={this.state.claseModalConfirm}>
                                ...
                                <ModalBody>
                                    ...
                                    <p align="center"><h5><b>{this.state.operacion}</b></h5></p>
                                </ModalBody>
                            </Modal>
                        </div>
